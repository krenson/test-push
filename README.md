...
* Image core component: 
    - The AdaptiveImageServlet is responsible for image processing and streaming when image core component is used and look like */image.coreimg.*/*
...
Go to http://publish.realdolmen.com/storybook    
