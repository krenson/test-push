...
public class GraphDataServletTest {
    private final AemContext ctx = new AemContext();

    @BeforeEach
    public void init() {
        ctx.addModelsForClasses(GraphDataServlet.class);
        ctx.load().json("/com/leforemhe/aem/site/core/servlets/GraphDataServletTest.json", "/content");
    ...
    void getCorrectGraphData() throws ServletException, IOException {
        ...
        parameters.put(GraphDataServlet.CHART_DATA_PATH_PARAM, "/content/dam/chart-data.json");
        request.setParameterMap(parameters);

        GraphDataServlet servlet = ctx.registerInjectActivateService(new GraphDataServlet());
    ...
    void getGraphDataFileNotFound() throws ServletException, IOException {
        ...
        request.setMethod("GET");
        Map<String, Object> parameters = new HashMap<String, Object>();
        parameters.put(GraphDataServlet.CHART_DATA_PATH_PARAM, "/content/dam/chart-data-not-found.json");
        request.setParameterMap(parameters);
