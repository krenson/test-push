...
public class NavigationImageItemModel {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(NavigationImageItemModel.class);
    ...
    @Default(values = NavigationImageItemModel.INTERNAL_LINK)
    @ValueMapValue
    private String linkType;
    @Default(values = NavigationImageItemModel.BLANK_TARGET)
    @ValueMapValue
    ...
    public void init() {
        ...
        if (isInternal()) {
            target = NavigationImageItemModel.SELF_TARGET;
        }
    }
    ...
    public boolean opensNewTab() {
        return this.getTarget().equals(NavigationImageItemModel.BLANK_TARGET);
    }
