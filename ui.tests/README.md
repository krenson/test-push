...
| `AEM_PUBLISH_URL`       | false     | `http://localhost:4503` | URL of the publish instance |
...
will build Docker image `<groupid>.ui.tests/ui.tests` locally
...
```
mvn verify -Pui-tests-docker-execution -DAEM_AUTHOR_URL=http://host.docker.internal:4502 -DAEM_PUBLISH_URL=http://host.docker.internal:4503
```
